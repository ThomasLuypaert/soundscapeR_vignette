...
ss_pcoa(soundscape_list = balbina, 
        grouping = c("Andre", rep("Mascote", 4)))
...
But not all soundscapes in our study system are equal - some are more similar to others. For example, we have four soundscapes from Mascote island, but only one soundscape from Andre island. We can incorporate this 'grouping' or 'hierarchical structure' into our our diversity partitioning calculations. 
